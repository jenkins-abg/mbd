...
set job_path=C:\jenkins_edc\JenkinsHome\jobs\DSS_UnitTest_TestFix
mkdir %job_path%\tmp
...
set ZIPTIME=!ZIPTIME::=!
set ZIPTIME=!ZIPTIME:.=!
"C:\Program Files\7-Zip\7z.exe" a -tzip %transfer_atg_path%\%ZIPTIME%_UnitTestFixResult.zip %job_path%\tmp\* -sdel
