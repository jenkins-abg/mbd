...
:: extract IDs
"C:\Program Files\7-Zip\7z.exe" x -tzip %atg_path% -o%job_path%\tmp -y
:: extract winAMS
"C:\Program Files\7-Zip\7z.exe" x -tzip %3 -o%job_path%\winams -y
...
:: check if there is winAMS environment
    ...
    :: call vbs to perform static fixing
       call %~dp0function\log_with_date.bat "  stage_4_test_fix_static begin..." 
